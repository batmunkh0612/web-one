...
import { UNIVERSITY_ADV_CUES } from "./universityAdvCues";
import { UNIVERSITY_DEVICE_PINS } from "./universityDevicePins";
import { UNIVERSITY_DISAD_CUES } from "./universityDisadCues";
  ...
  return (
    ...
    text-[80px]"
          ...
          <video
            ...
            src="/videos/university/university_before.mp4"
            autoPlay
            muted
            playsInline
            loop
          ...
          <video
            ...
            src="/videos/university/university_after.mp4"
            autoPlay
            muted
            playsInline
            loop
          ...
          <div className="absolute inset-0" style={{ clipPath: afterClipPath }}>
            <div className="absolute inset-0 pointer-events-none">
              <AdvTextOverlay
                ...
                cues={UNIVERSITY_ADV_CUES}
                defaultVideoSize={videoSize}
              />
            </div>

            <div className="absolute inset-0 pointer-events-auto">
              {UNIVERSITY_DEVICE_PINS.map((pin) => (
                <DevicePinMarker
                  key={pin.id}
                  id={pin.id}
                  x={pin.x}
