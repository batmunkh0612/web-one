...
import { OFFICE_ADV_CUES } from "./officeAdvCues";
import { OFFICE_DEVICE_PINS } from "./officeDevicePins";
import { OFFICE_DISAD_CUES } from "./officeDisadCues";
  ...
  return (
    ...
    text-[80px]"
          ...
          <video
            ...
            src="/videos/office/office_before.mp4"
            autoPlay
            muted
            playsInline
            loop
          ...
          <video
            ...
            src="/videos/office/office_after.mp4"
            autoPlay
            muted
            playsInline
            loop
          ...
          <div className="absolute inset-0" style={{ clipPath: afterClipPath }}>
            <div className="absolute inset-0 pointer-events-none">
              <AdvTextOverlay
                ...
                cues={OFFICE_ADV_CUES}
                defaultVideoSize={videoSize}
              />
            </div>

            <div className="absolute inset-0 pointer-events-auto">
              {OFFICE_DEVICE_PINS.map((pin) => (
                <DevicePinMarker
                  key={pin.id}
                  id={pin.id}
                  x={pin.x}
